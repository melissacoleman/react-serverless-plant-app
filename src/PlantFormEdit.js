...
class PlantFormEdit extends React.Component {
    state = {};
...
export default graphql(UpdatePlant, {
    props: props => ({
        onUpdate: plant =>
            props.mutate({
                variables: plant,
                optimisticResponse: {
                    __typename: "Mutation",
                    updatePlant: { ...plant, __typename: "Plant" }
                },
                update: (proxy, { data: { updatePlant } }) => {
                    ...
                    data.listPlants.items.push(updatePlant);
...
const styles = {
    ...
    plant: {
        boxShadow: "0px 0px 54px 0px rgba(0,0,0,0.15)",
        WebkitBoxShadow: "0px 0px 54px 0px rgba(0,0,0,0.15)",
        MozBoxShadow: "0px 0px 54px 0px rgba(0,0,0,0.15)",
        marginBottom: 7,
        padding: 14,
